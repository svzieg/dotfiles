...
def main():
    ...
    ops = [
        ...
        ('ap', 'apply --recursive -f', None, None),
    ...
    res = [
        ...
        # Istio
        ('vs', 'virtualservice', ['g', 'd', 'rm'], ['sys']),
        ('nm', 'networkpolicies', ['g', 'd', 'rm'], ['sys']),
        ('pol', 'policies', ['g', 'd', 'rm'], ['sys']),
        ('dr', 'destinationrules', ['g', 'd', 'rm'], ['sys']),
        ('gw', 'gateways', ['g', 'd', 'rm'], ['sys']),
        ('cert', 'certificates', ['g', 'd', 'rm'], ['sys']),
